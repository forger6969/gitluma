...
const Navbar = () => {
  ...
  const navLinks = [
    { label: t("platform") },
    { label: t("documentation"), path: "/docs" },
    { label: t("changelog") },
  ];
    ...
    >
      <div className="flex items-center gap-2.5 select-none">
        <div
          ...
          style={{ background: "rgba(232,101,74,0.12)", color: "var(--gl-coral)" }}
        >
          <BoltIcon />
        </div>
      ...
      <div className="hidden md:flex items-center gap-0.5">
        {navLinks.map((link, index) => {
          const Component = link.path ? Link : "button";
          const props = link.path ? { to: link.path, style: { textDecoration: "none" } } : {};
          ...
          return (
            <Component
              ...
              style={{
                color: activeLink === index ? "var(--gl-coral)" : "var(--gl-muted)",
                background: activeLink === index ? "var(--gl-coral-bg)" : "transparent",
              }}
