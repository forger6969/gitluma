...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div className="bg-[#161b27] rounded-[18px] px-7 pt-7 pb-[22px] w-full max-width-[340px] flex flex-col items-center"
        style={{ maxWidth: 340 }}>

        {/* Button */}
        <button
          onClick={loginWithGithub}
          className="w-full bg-[#6c6be8] hover:bg-[#7877f0] active:scale-[0.98] text-white border-none rounded-[10px] py-[13px] px-5 text-[15px] font-medium flex items-center justify-center gap-[10px] transition-all duration-150 mb-5 cursor-pointer"
        >
