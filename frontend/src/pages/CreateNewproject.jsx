...
//             <div
//               onClick={openModal}
//               className="w-full px-4 py-3 text-sm rounded-lg bg-[#F8F9FC] border border-[#E4E8F0] text-[#8A93A8] cursor-pointer hover:border-[#C8D0E0] hover:bg-white hover:text-[#1A1F2E] transition-all flex items-center gap-2"
//             >
//               <svg
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          >
            ...
            >
              ...
              >
                GitHub repositoriyasini ulang — commitlar va pull requestlar
                vazifalaringizga bog'lanadi.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            {/* <button
              type="submit"
              disabled={submitting}
              className="px-7 py-3 text-sm rounded-xl bg-gradient-to-br  text-white font-semibold shadow-[0_6px_20px_rgba(109,40,217,0.3)] hover:shadow-[0_8px_26px_rgba(109,40,217,0.4)] hover:-translate-y-0.5 active:translate-y-0 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none"
            >
              {submitting ? t("creating") : t("create")}
            </button> */}
