...
const Toast = ({ toast, onDismiss, C }) => {
  ...
  }[toast.type] || { border: C.coral, bg: C.coralBg, icon: C.coral, bar: C.coral };
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: "12px", fontWeight: 700, color: C.heading, marginBottom: "2px" }}>
          {toast.title}
        </p>
        <p style={{
          fontSize: "11px", color: C.muted, lineHeight: 1.4,
      ...
      <div style={{
        ...
        backgroundColor: accent.bar, opacity: 0.35,
...
export const ToastContainer = ({ toasts, onDismiss, C }) => (
  <div style={{
