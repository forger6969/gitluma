...
import newMember from '../assets/Member.png'
const NewMember = () => {
  return (
    <div className='w-[100%] bg-[#181C22] flex gap-[50px] items-center bg-base-200/60 border border-base-300 rounded-xl px-4 py-4 mb-4'>
           <div className='w-[50px] items-center flex flex-col   rounded-[20%] bg-[#5E56D133] h-[50px]'>
                <img className='mx-auto w-[25px] my-auto' src={newMember} alt="icon" />
           </div>
           <div className='w-[90%]'>
